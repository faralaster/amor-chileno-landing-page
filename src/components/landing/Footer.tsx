    ...
    <footer className="bg-slate-900 text-slate-200 py-8">
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold font-headline text-white">Frutilla Amor Chileno</h3>
            <p className="text-sm text-slate-400">Transformando frutillas en sonrisas y ganancias.</p>
        </div>
        ...
        <div className="text-sm text-slate-400">
          <p>&copy; {new Date().getFullYear()} Frutilla del Amor Chileno. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
